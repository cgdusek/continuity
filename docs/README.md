...
5. `dashboard-ui.md` - Plugin dashboard route, control meanings, and review workflow
6. `development-and-ci.md` - Local commands, packaging scripts, and CI execution model
...
- dashboard route behavior in `src/continuity/route.ts` -> `dashboard-ui.md`
